...
HD_PWD='D:/University/Junior/FPGA/Snake_Game_V3/snake_game/snake_game.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Top_SnakeGame.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Top_SnakeGame.tcl -notrace
