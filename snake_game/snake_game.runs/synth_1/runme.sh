...
HD_PWD='D:/University/Junior/FPGA/Snake_Game_V3/snake_game/snake_game.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Top_SnakeGame.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Top_SnakeGame.tcl
