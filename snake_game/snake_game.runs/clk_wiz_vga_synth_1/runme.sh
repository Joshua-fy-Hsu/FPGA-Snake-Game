...
HD_PWD='D:/University/Junior/FPGA/Snake_Game_V3/snake_game/snake_game.runs/clk_wiz_vga_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log clk_wiz_vga.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source clk_wiz_vga.tcl
